...
$list = yumdata_array("SELECT * FROM `attractions` WHERE `type` = ? ORDER BY `name`", array('SEE'));
?>
<!doctype html>
<html lang="en-US">
<head>
...
<div id="siteframe">
    <div id="wrapper">
        ...
        <main>
        	<section id="featured_header" style="background-image:url(../images/sample_bg_see.jpg);">
                <div class="inner">
                    <div class="pad">
                        <h1>What to see in Leechburg</h1>
                    </div>
                </div>
            </section>
